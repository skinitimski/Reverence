...
namespace Atmosphere.BattleSimulator
{
    public class Character
    {
        ...
        public static Character Cloud;
        public static Character Aeris;
        public static Character Tifa;
        public static Character Barret;
        public static Character RedXIII;
        public static Character Yuffie;
        public static Character CaitSith;
        public static Character Vincent;
        public static Character Cid;
        public static Character Sephiroth;
...
//        public const string DIFFS_TABLEFILE = @"Data\diffs.table";
        ...
        private Character(string dataxmlstring)
        {
        ...
        {
            if (level < 1)
                throw new GameImplementationException("Level cannot be less than 1 - not in any bracket.");
            if (level < 12)
                return 0;
            else if (level < 22)
                return 1;
                ...
                throw new GameImplementationException("Level cannot be greater than 99 - not in any bracket.");
        }
        ...
        private void LevelUp()
        {
            ...
            int diff_str = Game.Random.Next(1, 9) + Baseline(0) - _strength_base;
            if (diff_str < 0) diff_str = 0;
            if (diff_str > 11) diff_str = 11;
            _strength_base += _diff_gain[diff_str];


            int diff_vit = Game.Random.Next(1, 9) + Baseline(1) - _vitality_base;
            if (diff_vit < 0) diff_vit = 0;
            if (diff_vit > 11) diff_vit = 11;
            _vitality_base += _diff_gain[diff_vit];


            int diff_mag = Game.Random.Next(1, 9) + Baseline(2) - _magic_base;
            if (diff_mag < 0) diff_mag = 0;
            if (diff_mag > 11) diff_mag = 11;
            _magic_base += _diff_gain[diff_mag];


            int diff_spi = Game.Random.Next(1, 9) + Baseline(3) - _spirit_base;
            if (diff_spi < 0) diff_spi = 0;
            if (diff_spi > 11) diff_spi = 11;
            _spirit_base += _diff_gain[diff_spi];


            int diff_dex = Game.Random.Next(1, 9) + Baseline(4) - _dexterity_base;
            if (diff_dex < 0) diff_dex = 0;
            if (diff_dex > 11) diff_dex = 11;
            ...
            int diff_lck = Game.Random.Next(1, 9) + luck_baseline - _luck_base;
            if (diff_lck < 0) diff_lck = 0;
            if (diff_lck > 11) diff_lck = 11;
            ...
            int diff_hp = Game.Random.Next(1, 9) + (100 * hp_baseline / _maxhp) - 100;
            if (diff_hp < 0) diff_hp = 0;
            if (diff_hp > 11) diff_hp = 11;
            ...
            int diff_mp = Game.Random.Next(1, 9) + (100 * mp_baseline / _maxmp) - 100;
            if (diff_mp < 0) diff_mp = 0;
            if (diff_mp > 11) diff_mp = 11;
        ...
        public void IncrementStrength() { _strength_bonus++; }
        public void IncrementDexterity() { _dexterity_bonus++; }
        public void IncrementVitality() { _vitality_bonus++; }
        public void IncrementMagic() { _magic_bonus++; }
        public void IncrementSpirit() { _spirit_bonus++; }
        public void IncrementLuck() { _luck_bonus++; }
        ...
        public bool BackRow { get { return _backRow; } set { _backRow = value; } }
        ...
        public Weapon Weapon
        {
            ...
            {
                if (value == null)
                    throw new GameImplementationException("Cannot remove weapon. Must replace with new weapon.");
                _weapon.Detach(this);
                _weapon = value;
                _weapon.Attach(this);
            }
        ...
        public Armor Armor
        {
            ...
            {
                if (value == null)
                    throw new GameImplementationException("Cannot remove armor. Must replace with new armor.");
                _armor.Detach(this);
                _armor = value;
                _armor.Attach(this);
            }
        ...
        public static Dictionary<string, Character> Table { get { return _table; } }
